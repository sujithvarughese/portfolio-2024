...
export const aboutMeUpdated = "Hi there! I am a motivated web and mobile developer specializing in full stack development. I've created several projects from the ground up, handling everything from design to deployment and testing. My go-to tools are React and React Native for building responsive, user-friendly applications. On the backend, I utilize NodeJS and Express to develop robust full-stack solutions. In every project, my goal is to turn ideas into reality through clean, scalable code which can translate efficiently into intuitive user experiences.\n\nI have experience working with APIs, and my experience with AI is highlighted by my work incorporating the OpenAI API into various projects, crafting prompts that deliver accurate and personalized responses. When I'm not coding, you'll find me playing basketball, playing chess, editing videos, or spending quality time with my 10-year-old Rottweiler, Hera."
