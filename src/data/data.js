...
export const skills = ['JavaScript', 'Python', 'Java', 'OpenAI', 'React', 'React Native', 'Expo', 'NodeJS', 'APIs', 'Data Structures', 'HTML', 'CSS', 'MongoDB', 'SQL', 'Firebase',   'Material UI', 'ChakraUI', 'Styled Components', 'Bootstrap', 'Tailwind CSS', 'Google Analytics', 'DNS & Networks', 'Git', 'Deployment']
