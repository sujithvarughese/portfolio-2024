...
export const aboutMeUpdated = "\n" +
    "As a passionate software developer, I specialize in crafting intuitive user experiences and dynamic applications using a versatile stack of technologies. With expertise in React, React Native, HTML, CSS, and JavaScript, I thrive on turning ideas into reality through clean, efficient code. Whether it's building responsive web interfaces that adapt flawlessly to various devices or developing cross-platform mobile apps that seamlessly integrate with users' lifestyles, I am committed to delivering solutions that exceed expectations.\n\nDriven by a genuine love for problem-solving and a dedication to staying abreast of emerging trends in the tech industry, I approach every project with creativity and precision. My ability to collaborate seamlessly within interdisciplinary teams, coupled with a knack for translating complex concepts into user-friendly solutions, empowers me to tackle challenges head-on and deliver results that elevate user engagement and satisfaction. With a proven track record of successful projects and a relentless pursuit of excellence, I am poised to bring innovative ideas to life in the ever-evolving landscape of software development."
...
export const deploymentSkills = "Proficient in software life cycle from design to deployment, including testing, DNS configurations, and app store publishing."
