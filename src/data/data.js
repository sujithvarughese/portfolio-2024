...
export const aboutMeUpdated = "As a passionate software developer, I specialize in designing intuitive user experiences and dynamic applications using JavaScript, React, & React Native. In every project, my goal is to turn ideas into reality through clean, scalable code which translate efficiently to user-friendly solutions. Through my experience, I had the opportunity to learn and understand the software developmental life cycle from planning and designing through testing, deployment, and maintenance.\n\nAside from programming, I enjoy working out, playing basketball, creating and editing videos, playing chess, and hanging out with my pup."
...
export const fullStackSkills = "Over two years experience in React, React Native, NextJS, HTML, CSS, NodeJS, Express, SQL, and MongoDB."
